        ...
        <div className="kp-container">
          <div className="grid gap-6 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            <article className="rounded-lg border border-border bg-card p-6 shadow-card">
              ...
              <h2 className="mt-2 text-3xl font-bold text-foreground">Сервіс підбору запчастин сьогодні, цифровий майданчик завтра</h2>
            ...
            <aside className="rounded-lg border border-border bg-card p-6 shadow-card">
              ...
              <h2 className="mt-2 text-2xl font-bold text-foreground">Підбір запчастин за заявкою</h2>
