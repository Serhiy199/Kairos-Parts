...
:root {
  ...
  --font-brand: Orbitron, "Exo 2", Inter, ui-sans-serif, system-ui, sans-serif;
...
- Brand/display font: `Orbitron` для латинських брендових елементів, CTA та технічного настрою. Для українських заголовків і менш декоративного вигляду використовується `Exo 2` як display fallback із підтримкою кирилиці.
