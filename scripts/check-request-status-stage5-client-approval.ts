...
assert.ok(clientUi.includes('ClientSelectionCheckboxList'));
assert.ok(!clientUi.includes('ClientSelectionDecisionControls'));
assert.ok(checkboxUi.includes('Ви погодили цю позицію.'));
assert.ok(checkboxUi.includes('Позицію відхилено.'));
